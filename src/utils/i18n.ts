...
export const translations = {
  en: {
    ...
    missingInfoAlertMsg: 'Please select a member and enter valid quantity (>0) and fat % (3–15).',
    savedAlert: '✅ Saved!',
  ...
  hi: {
    ...
    missingInfoAlertMsg: 'कृपया सदस्य चुनें और सही मात्रा (>0) व फैट % (3–15) दर्ज करें।',
